# docker-hello-world
[![Build Status](https://github.com/alexf4dev/docker-hello-world/workflows/publish/badge.svg)](https://github.com/alexf4dev/docker-hello-world/actions)
[![renovateenabled](https://img.shields.io/badge/renovate-enabled-yellow)](https://renovatebot.com)

Example hello world container showing how to use GitHub Container Registry


As Docker Inc introduced a rate-limiting https://www.docker.com/increase-rate-limits I began to bump [into problems like this](https://github.com/alexf4dev/molecule-ansible-docker-aws/runs/1968417806?check_suite_focus=true) while running a simple `docker run hello-world` on GitHub Actions:
...
```shell
docker run ghcr.io/alexf4dev/hello-world
```
...
```yaml
        docker build . --tag ghcr.io/alexf4dev/hello-world:latest
        docker run ghcr.io/alexf4dev/hello-world:latest
        docker push ghcr.io/alexf4dev/hello-world:latest
```
...
```dockerfile
LABEL org.opencontainers.image.source="https://github.com/alexf4dev/docker-hello-world"
```
...
To make it publicly accessible we need to move to our user account or orga page. For my account this is https://github.com/alexf4dev?tab=packages
...
```shell
docker pull ghcr.io/alexf4dev/hello-world:latest
